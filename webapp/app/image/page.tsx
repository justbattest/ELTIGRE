  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12 space-y-6">
        ...
        <p className="text-gray-400">Scraping Instagram + génération d&apos;images Higgsfield.</p>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Link href="/" className="bg-gray-900 border border-gray-800 rounded-2xl p-6 hover:border-violet-500 transition group">
            ...
            <p className="text-gray-500 text-sm mt-1">Scrape des profils Instagram, analyse les posts et génère des images.</p>
          </Link>
          <Link href="/studio" className="bg-gray-900 border border-gray-800 rounded-2xl p-6 hover:border-violet-500 transition group">
            ...
            <p className="text-gray-500 text-sm mt-1">Génère des images avec des prompts personnalisés et des paramètres avancés.</p>
          </Link>
        </div>
      </div>
    </div>
