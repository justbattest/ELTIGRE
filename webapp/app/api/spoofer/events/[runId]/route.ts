/**
 * GET /api/spoofer/events/[runId]
 * SSE stream des events du run Spoofer 2.0.
 * Lit depuis le singleton partagé lib/spoofer-state.
 *
 * Mirror exact de webapp/app/api/metadata/events/[runId]/route.ts.
 */
