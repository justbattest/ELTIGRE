...
const CHIPS: Record<keyof Selections, string[]> = {
  lieu: [
    ...
    'Apartment bedroom morning light', 'Hotel bathroom mirror', 'Gym locker room post-workout',
    'Uber backseat night city', 'Elevator mirror lobby', 'Office desk midday sun',
    'Rooftop bar golden hour', 'Whole Foods produce aisle', 'Parking garage concrete',
    'Hair salon chair', 'Airport gate window seat', 'Home kitchen island',
    'Yoga mat living room', 'Outdoor patio string lights', 'Shopping mall escalator',
    'Laundromat waiting', 'Bookstore aisle browse',
  ],
  activite: [
    ...
    'Adjusting earring reflection', 'Tying shoelace on bench', 'Applying lip gloss compact',
    'Texting one hand on hip', 'Reaching top shelf', 'Stepping out of car',
    'Pulling hair messy bun', 'Wiping sweat forearm', 'Leaning on railing looking away',
    'Picking up bag floor', 'Stretching arms overhead', 'Checking watch walking',
  ],
  outfit: [
  ...
  background: [
    ...
    'NYC street corner', 'Café de Flore terrace Paris 6e', 'Gym locker room', 'Hotel bathroom mirror',
    'Yoga studio', 'Beverly Hills palm trees', 'SoHo storefront', 'Venice Beach near lifeguard tower',
  ],
  shotType: [
    'Selfie chest-up', 'Mirror full-body', 'Candid waist-up', 'Vlog POV', 'Close-up face',
    'Over-shoulder', 'Gym mirror waist-up',
    'Friend snapped candid', 'Paparazzi telephoto 200mm', 'Caught mid-laugh friend',
    'FaceTime screenshot grain', 'Boyfriend POV table', 'Mirror behind gym rack',
    'Phone on shelf timer', 'Car rearview mirror', 'Ring light studio',
    'Tripod timer full body 3m', 'Caught from side',
  ],
  colorGrade: [
    'Soft window: warm highlights, grey shadows, neutral mids',
    'Golden hour: amber highlights, purple-blue shadows, warm mids',
    'Fluorescent indoor: green-white highlights, hard grey shadows, desaturated mids',
    'Overcast diffused: flat cool highlights, blue-grey shadows, low contrast',
    'Night tungsten: orange highlights, deep blue shadows, warm mids',
    'Morning blue: cool highlights, purple shadows, neutral mids',
    'Gym LED: flat white highlights, minimal shadows, green tint mids',
    'Candlelight: deep amber highlights, black shadows, warm orange mids',
  ],
  features: [
